...
import 'package:coffee_shop/components/coffee_size.dart';
...
class Detail extends StatefulWidget {
  ...
  const Detail({super.key, this.coffeeItem});
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        widget.coffeeItem?.rating.toString() ?? "4.8",
                        style: GoogleFonts.sora(
                          fontSize: 16,
                          fontWeight: FontWeight.w600,
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            "\$ ${widget.coffeeItem?.price.toStringAsFixed(2) ?? "4.53"}",
                            style: GoogleFonts.sora(
                                fontSize: 18,
                                fontWeight: FontWeight.w600,
                                color: const Color(0xffC67C4E)),
